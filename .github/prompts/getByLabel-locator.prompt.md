...
If the element is not a form control or does not have any associated label or accessible label, respond with: "getByLabel is not suitable for this element"
