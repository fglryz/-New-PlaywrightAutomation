...
Your task is to generate a short and unique getByTestId() locator for the given HTML code using a stable `data-testid` attribute.

If the element does not have a meaningful `data-testid` attribute, respond with: "getByTestId is not suitable for this element"
