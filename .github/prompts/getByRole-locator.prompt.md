...
If the element does not have a meaningful role or accessible name (for example it is just a generic div or span with no role, label, or useful text), respond with: "getByRole is not suitable for this element"
