...
If the element does not have meaningful or stable visible text (for example, it is only an icon, the text is clearly dynamic, or the only text is a very long paragraph), respond with: "getByText is not suitable for this element"
